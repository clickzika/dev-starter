# /devstarter-import — Import Dev Starter from Backup
...
```
/devstarter-import                                  → import from Desktop/dev-starter-v1.zip
/devstarter-import C:\backup\dev-starter-v1.zip     → import from specific file
```
