...
EXTENDED_AGENTS="devstarter-architect devstarter-datascience devstarter-sre devstarter-api devstarter-performance devstarter-code-reviewer devstarter-typescript-reviewer devstarter-python-reviewer devstarter-go-reviewer devstarter-java-reviewer devstarter-csharp-reviewer devstarter-rust-reviewer devstarter-kotlin-reviewer devstarter-swift-reviewer devstarter-flutter-reviewer devstarter-cpp-reviewer devstarter-django-reviewer devstarter-fastapi-reviewer devstarter-fsharp-reviewer devstarter-mle-reviewer devstarter-build-resolver devstarter-typescript-build-resolver devstarter-go-build-resolver devstarter-java-build-resolver devstarter-rust-build-resolver devstarter-swift-build-resolver devstarter-flutter-build-resolver devstarter-django-build-resolver devstarter-pytorch-build-resolver devstarter-cpp-build-resolver devstarter-kotlin-build-resolver devstarter-dart-build-resolver devstarter-planner devstarter-tdd-guide devstarter-refactor devstarter-code-explorer devstarter-code-simplifier devstarter-database-reviewer devstarter-security-reviewer devstarter-a11y-architect devstarter-network-architect devstarter-seo devstarter-silent-failure-hunter devstarter-type-analyzer devstarter-pr-analyzer devstarter-chief-of-staff devstarter-code-architect devstarter-comment-analyzer devstarter-conversation-analyzer devstarter-doc-updater devstarter-docs-lookup devstarter-e2e-runner devstarter-harness-optimizer devstarter-loop-operator devstarter-pr-test-analyzer devstarter-network-config-reviewer devstarter-network-troubleshooter devstarter-healthcare-reviewer devstarter-homelab-architect devstarter-harmonyos-app-resolver devstarter-gan-planner devstarter-gan-generator devstarter-gan-evaluator devstarter-opensource-forker devstarter-opensource-sanitizer devstarter-opensource-packager"
