...
2. Read `~/.claude/dev-github.md` → follow PROC-GH-03 (create migration branch)
3. Read `~/.claude/dev-notion.md` → follow PROC-NT-01 + PROC-NT-02 (create migration task board)
4. Save `.project.env`
...
- [ ] Read `~/.claude/dev-github.md` → PROC-GH-04: create labels
