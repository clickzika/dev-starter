...
| v3.9.0 | [ ] Distribution — Windows EXE installer (Inno Setup) + npm package (`npx devstarter init`); professional cross-platform distribution replacing raw bash-only install |
